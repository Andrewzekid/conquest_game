...
const ICONS = {
  ...
  COMBAT_ENGINEER: `<circle cx="12" cy="5" r="2.2" fill="${C.steel}"/><path d="M8 11 l4 -2 4 2 -1 7 h-6 Z" fill="${C.steel}" stroke="${C.darkSteel}" stroke-width="0.8"/><path d="M16 13 l4 -4 -1.4 1.4 1.4 1.4 -1.4 1.4 1.4 1.4 -4 4 Z" fill="${C.iron}" stroke="${C.darkSteel}" stroke-width="0.6"/><path d="M12 12 l3 3" stroke="${C.fire}" stroke-width="1.2"/>`,
  ...
  MOBILIZED_INFANTRY: `<circle cx="12" cy="5" r="2.2" fill="${C.steel}"/><path d="M8 11 l4 -2 4 2 -1 7 h-6 Z" fill="${C.steel}" stroke="${C.darkSteel}" stroke-width="0.8"/><path d="M14 8 l6 -1 -1 4 -2 0 Z" fill="${C.darkSteel}" stroke="${C.shadow}" stroke-width="0.6"/><rect x="4" y="14" width="6" height="3" fill="${C.iron}" opacity="0.5"/>`,
  MOBILIZED_ARTILLERY: `<path d="M4 16 h10 l-2 -4 H6 Z" fill="${C.darkSteel}"/><circle cx="6" cy="18" r="2" fill="none" stroke="${C.iron}" stroke-width="1.6"/><circle cx="12" cy="18" r="2" fill="none" stroke="${C.iron}" stroke-width="1.6"/><path d="M13 12 l5 -2 -1 4 -2 1 Z" fill="${C.steel}"/><rect x="4" y="14" width="6" height="3" fill="${C.iron}" opacity="0.5"/>`,
