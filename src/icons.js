...
const ICONS = {
  ...
  ARTILLERY: `<path d="M4 16 h10 l-2 -4 H6 Z" fill="${C.darkSteel}"/><circle cx="7" cy="17" r="2" fill="none" stroke="${C.iron}" stroke-width="1.6"/><circle cx="13" cy="17" r="2" fill="none" stroke="${C.iron}" stroke-width="1.6"/><path d="M13 12 l6 -3 -1 5 -3 1 Z" fill="${C.iron}" stroke="${C.darkSteel}" stroke-width="0.6"/>`,
  SPY: `<circle cx="12" cy="5" r="2.2" fill="${C.shadow}"/><path d="M9 11 l3 -2 3 2 -1 7 h-4 Z" fill="${C.shadow}" stroke="${C.shadow}" stroke-width="0.8"/><circle cx="17" cy="9" r="2.6" fill="none" stroke="${C.steel}" stroke-width="1.4"/><path d="M17 6.4 v5.2 M14.4 9 h5.2" stroke="${C.steel}" stroke-width="1"/>`,
  // Renaissance era
  MUSKETEER: `<circle cx="12" cy="5" r="2.2" fill="${C.steel}"/><path d="M8 11 l4 -2 4 2 -1 7 h-6 Z" fill="${C.steel}" stroke="${C.darkSteel}" stroke-width="0.8"/><path d="M15 8 l5 -1 -1 5 -2 0 Z" fill="${C.darkSteel}" stroke="${C.shadow}" stroke-width="0.6"/><path d="M18 10 l2 1" stroke="${C.gold}" stroke-width="1"/>`,
  ARQUEBUSIER: `<circle cx="12" cy="5" r="2.2" fill="${C.leather}"/><path d="M8 11 l4 -2 4 2 -1 7 h-6 Z" fill="${C.leatherLt}" stroke="${C.shadow}" stroke-width="0.8"/><path d="M15 8 l5 -2 -1 4 -2 0 Z" fill="${C.darkSteel}" stroke="${C.shadow}" stroke-width="0.6"/>`,
  MAN_OF_WAR: `<path d="M2 13 h20 l-3 6 H5 Z" fill="${C.woodDark}"/><path d="M8 13 V2 h3 v11 M13 13 V5 h3 v8 M17 13 V8 h2 v5" fill="none" stroke="${C.steel}" stroke-width="1.4"/><path d="M5 19 q7 3 14 0" fill="${C.water}"/>`,
  GALLEASS: `<path d="M3 13 h18 l-3 5 H6 Z" fill="${C.wood}"/><path d="M9 13 V4 h3 v9 M14 13 V7 h3 v6" fill="none" stroke="${C.steel}" stroke-width="1.4"/><circle cx="12" cy="14" r="1.6" fill="${C.darkSteel}"/>`,
  PINNACE: `<path d="M4 14 h16 l-2 4 H6 Z" fill="${C.wood}"/><path d="M12 5 v9 M12 5 l4 5 M12 8 l-3 4" stroke="${C.steel}" stroke-width="1.4"/><path d="M6 18 q6 3 12 0" fill="${C.water}"/>`,
  // Enlightenment era
  LINE_INFANTRY: `<circle cx="12" cy="5" r="2.2" fill="${C.steel}"/><path d="M8 11 l4 -2 4 2 -1 7 h-6 Z" fill="${C.darkSteel}" stroke="${C.shadow}" stroke-width="0.8"/><path d="M12 3 v-1.5" stroke="${C.red}" stroke-width="1.2"/><path d="M14 9 l5 -1 -1 4 -2 0 Z" fill="${C.iron}" stroke="${C.darkSteel}" stroke-width="0.6"/><path d="M9 11 l-3 1 M15 11 l3 1" stroke="${C.gold}" stroke-width="0.8"/>`,
  DRAGOON: `<path d="M5 16 q-1 -5 4 -6 q3 -4 7 -2 q1 4 -2 5 l3 1 -1 3 -3 -1 q-1 3 -4 2 q-3 0 -4 -2 Z" fill="${C.steel}" stroke="${C.darkSteel}" stroke-width="0.8"/><circle cx="9" cy="7" r="2" fill="${C.steel}"/><path d="M16 8 l5 -2 -1 5 -2 0 Z" fill="${C.darkSteel}" stroke="${C.shadow}" stroke-width="0.6"/>`,
  CANNON: `<path d="M4 17 h12 l-2 -4 H6 Z" fill="${C.darkSteel}"/><circle cx="7" cy="18" r="2" fill="none" stroke="${C.iron}" stroke-width="1.6"/><circle cx="14" cy="18" r="2" fill="none" stroke="${C.iron}" stroke-width="1.6"/><path d="M14 13 l5 -2 -1 4 -2 1 Z" fill="${C.darkSteel}"/><path d="M9 11 l4 0" stroke="${C.iron}" stroke-width="1.6"/>`,
  MORTAR: `<path d="M8 18 h8 l-1 -3 H9 Z" fill="${C.darkSteel}"/><path d="M12 15 v-5 l4 -3" stroke="${C.iron}" stroke-width="2" stroke-linecap="round"/><circle cx="12" cy="18" r="1" fill="${C.darkSteel}"/><path d="M16 7 l1 2 -2 0 Z" fill="${C.steel}"/>`,
  CORVETTE: `<path d="M3 13 h18 l-3 5 H6 Z" fill="${C.wood}"/><path d="M12 3 v10 M12 3 l5 6" stroke="${C.steel}" stroke-width="1.6"/><path d="M6 18 q6 3 12 0" fill="${C.water}"/><path d="M10 7 l4 0" stroke="${C.gold}" stroke-width="1"/>`,
  FROLIC: `<path d="M2 13 h20 l-3 6 H5 Z" fill="${C.iron}"/><path d="M8 13 V3 h3 v10 M14 13 V6 h3 v7" fill="none" stroke="${C.steel}" stroke-width="1.4"/><path d="M5 19 q7 3 14 0" fill="${C.water}"/><path d="M10 9 h4" stroke="${C.gold}" stroke-width="1"/>`,
  MERCHANTMAN: `<path d="M3 13 h18 l-3 5 H6 Z" fill="${C.wood}"/><path d="M8 13 V3 h3 v10 M14 13 V6 h3 v7" fill="none" stroke="${C.steel}" stroke-width="1.4"/><rect x="9" y="9" width="5" height="3" fill="${C.gold}" opacity="0.6"/>`,
  // Modern era
  RIFLEMAN: `<circle cx="12" cy="5" r="2.2" fill="${C.steel}"/><path d="M8 11 l4 -2 4 2 -1 7 h-6 Z" fill="${C.darkSteel}" stroke="${C.shadow}" stroke-width="0.8"/><path d="M14 8 l7 -2 -1 5 -2 0 Z" fill="${C.iron}" stroke="${C.darkSteel}" stroke-width="0.6"/><path d="M19 9 l2 1" stroke="${C.gold}" stroke-width="0.8"/>`,
  SHARPSHOOTER: `<circle cx="12" cy="5" r="2.2" fill="${C.green}"/><path d="M8 11 l4 -2 4 2 -1 7 h-6 Z" fill="${C.green}" stroke="${C.darkSteel}" stroke-width="0.8"/><circle cx="17" cy="9" r="2.6" fill="none" stroke="${C.steel}" stroke-width="1.4"/><path d="M14 8 l6 -1" stroke="${C.iron}" stroke-width="1.2"/>`,
  RAILGUN: `<path d="M4 18 h16" stroke="${C.darkSteel}" stroke-width="2"/><path d="M8 18 V10 M16 18 V10" stroke="${C.darkSteel}" stroke-width="2"/><path d="M6 10 h12 v4 H6 Z" fill="${C.iron}" stroke="${C.darkSteel}" stroke-width="0.8"/><path d="M18 12 l4 0" stroke="${C.fire}" stroke-width="1.6"/>`,
  ARMORED_TRAIN: `<rect x="3" y="12" width="8" height="6" fill="${C.darkSteel}" stroke="${C.shadow}" stroke-width="0.8"/><rect x="13" y="10" width="8" height="8" fill="${C.iron}" stroke="${C.darkSteel}" stroke-width="0.8"/><circle cx="7" cy="19" r="2" fill="${C.shadow}"/><circle cx="17" cy="19" r="2" fill="${C.shadow}"/><path d="M14 6 l4 0 M16 4 v6" stroke="${C.fire}" stroke-width="1.2"/>`,
  FIELD_GUN: `<path d="M4 17 h12 l-2 -4 H6 Z" fill="${C.darkSteel}"/><circle cx="7" cy="18" r="2" fill="none" stroke="${C.iron}" stroke-width="1.6"/><circle cx="13" cy="18" r="2" fill="none" stroke="${C.iron}" stroke-width="1.6"/><path d="M14 13 l6 -3 -1 5 -2 1 Z" fill="${C.steel}" stroke="${C.darkSteel}" stroke-width="0.6"/><path d="M18 10 l2 1" stroke="${C.fire}" stroke-width="1"/>`,
  HORSE_ARTILLERY: `<path d="M4 17 h10 l-2 -4 H6 Z" fill="${C.darkSteel}"/><circle cx="7" cy="18" r="2" fill="none" stroke="${C.iron}" stroke-width="1.6"/><circle cx="12" cy="18" r="2" fill="none" stroke="${C.iron}" stroke-width="1.6"/><path d="M13 13 l5 -2 -1 4 -2 1 Z" fill="${C.steel}"/><path d="M16 10 q2 -3 4 -1 q1 2 -1 3 l-3 0 Z" fill="${C.leather}" stroke="${C.darkSteel}" stroke-width="0.5"/>`,
  DEMOLITION_SQUAD: `<circle cx="12" cy="5" r="2.2" fill="${C.leather}"/><path d="M8 11 l4 -2 4 2 -1 7 h-6 Z" fill="${C.leather}" stroke="${C.shadow}" stroke-width="0.8"/><path d="M12 12 v4" stroke="${C.fire}" stroke-width="2" stroke-linecap="round"/><circle cx="12" cy="17" r="1.4" fill="${C.fire}" stroke="${C.red}" stroke-width="0.6"/>`,
  COMBAT_ENGINEER: `<path d="M9.5 3.5 Q12 2.5 14.5 3.5" fill="none" stroke="${C.darkSteel}" stroke-width="0.8"/><circle cx="12" cy="5" r="2.2" fill="${C.steel}"/><path d="M8 11 l4 -2 4 2 -1 7 h-6 Z" fill="${C.darkSteel}" stroke="${C.shadow}" stroke-width="0.8"/><path d="M16 12 l3 -3" stroke="${C.woodDark}" stroke-width="1.2"/><path d="M19 9 l2 -1 v2 Z" fill="${C.iron}" stroke="${C.darkSteel}" stroke-width="0.4"/><rect x="7" y="14" width="6" height="3" rx="0.5" fill="${C.fire}" stroke="${C.red}" stroke-width="0.5"/><circle cx="12" cy="15.5" r="0.6" fill="${C.gold}"/>`,
  SIEGE_CANNON: `<path d="M3 17 h14 l-2 -5 H5 Z" fill="${C.darkSteel}"/><circle cx="6" cy="18" r="2" fill="none" stroke="${C.iron}" stroke-width="1.6"/><circle cx="14" cy="18" r="2" fill="none" stroke="${C.iron}" stroke-width="1.6"/><path d="M15 12 l5 -3 -1 6 -2 1 Z" fill="${C.darkSteel}" stroke="${C.shadow}" stroke-width="0.6"/><path d="M19 9 l2 1" stroke="${C.fire}" stroke-width="1.2"/>`,
  STEAM_TRANSPORT: `<path d="M3 13 h18 l-3 5 H6 Z" fill="${C.iron}"/><rect x="8" y="7" width="8" height="6" fill="${C.darkSteel}"/><path d="M10 7 V4 h4 v3" fill="none" stroke="${C.steel}" stroke-width="1.4"/><circle cx="12" cy="3" r="1.4" fill="${C.steel}"/>`,
  GUNBOAT: `<path d="M4 14 h16 l-2 4 H6 Z" fill="${C.iron}"/><path d="M12 5 v9 M12 5 l4 5" stroke="${C.steel}" stroke-width="1.4"/><path d="M6 18 q6 3 12 0" fill="${C.water}"/><rect x="10" y="9" width="4" height="4" fill="${C.darkSteel}"/>`,
  IRONCLAD_FRIGATE: `<path d="M3 13 h18 l-3 6 H6 Z" fill="${C.iron}"/><rect x="8" y="8" width="8" height="5" fill="${C.darkSteel}"/><path d="M12 3 v5" stroke="${C.steel}" stroke-width="2"/><path d="M9 9 h6" stroke="${C.gold}" stroke-width="0.8"/>`,
  MONITOR: `<path d="M3 14 h18 l-3 5 H6 Z" fill="${C.iron}"/><rect x="9" y="6" width="6" height="8" rx="1" fill="${C.darkSteel}"/><path d="M12 4 v3" stroke="${C.steel}" stroke-width="2"/><circle cx="12" cy="10" r="1.6" fill="${C.steel}"/>`,
  FRIGATE_2: `<path d="M3 13 h18 l-3 5 H6 Z" fill="${C.steel}"/><path d="M12 2 v10 M12 2 l5 7" stroke="${C.steel}" stroke-width="1.6"/><rect x="9" y="9" width="4" height="4" fill="${C.darkSteel}"/><path d="M6 18 q6 3 12 0" fill="${C.water}"/>`,
  TORPEDO_BOAT: `<path d="M4 14 h16 l-2 4 H6 Z" fill="${C.darkSteel}"/><path d="M12 6 v8" stroke="${C.steel}" stroke-width="1.6"/><path d="M4 16 l-2 1 M20 16 l2 1" stroke="${C.fire}" stroke-width="1.4" stroke-linecap="round"/><path d="M6 18 q6 3 12 0" fill="${C.water}"/>`,
  // Anti-cavalry
  HALBERDIER: `<circle cx="12" cy="4" r="2.2" fill="${C.steel}"/><path d="M9 10 l3 -2 3 2 -1 8 h-4 Z" fill="${C.steel}"/><path d="M12 2 v14" stroke="${C.woodDark}" stroke-width="1.6"/><path d="M12 2 l3 2 -3 1 -3 -2 Z" fill="${C.iron}"/><path d="M15 4 l4 2 -1 3 -3 -1 Z" fill="${C.iron}" stroke="${C.darkSteel}" stroke-width="0.6"/>`,
  PIKE_MASTER: `<circle cx="12" cy="4" r="2.2" fill="${C.steel}"/><path d="M9 10 l3 -2 3 2 -1 8 h-4 Z" fill="${C.darkSteel}" stroke="${C.shadow}" stroke-width="0.8"/><path d="M12 2 v15" stroke="${C.woodDark}" stroke-width="1.8"/><path d="M12 2 l2 3 -2 1 -2 -3 Z" fill="${C.iron}"/><path d="M12 6 l4 1 -1 3 -3 -1 Z" fill="${C.gold}" stroke="${C.goldDeep}" stroke-width="0.5"/>`,
  BAYONET_RIFLE: `<circle cx="12" cy="5" r="2.2" fill="${C.steel}"/><path d="M8 11 l4 -2 4 2 -1 7 h-6 Z" fill="${C.darkSteel}" stroke="${C.shadow}" stroke-width="0.8"/><path d="M14 8 l6 -1 -1 4 -2 0 Z" fill="${C.iron}" stroke="${C.darkSteel}" stroke-width="0.6"/><path d="M19 7 l2 -1 -1 3 Z" fill="${C.steel}" stroke="${C.darkSteel}" stroke-width="0.4"/>`,
  ANTI_TANK_GUN: `<path d="M4 17 h14 l-2 -5 H6 Z" fill="${C.darkSteel}"/><circle cx="7" cy="18" r="2" fill="none" stroke="${C.iron}" stroke-width="1.6"/><circle cx="15" cy="18" r="2" fill="none" stroke="${C.iron}" stroke-width="1.6"/><path d="M15 12 l6 -4 -1 6 -2 1 Z" fill="${C.iron}" stroke="${C.darkSteel}" stroke-width="0.6"/><path d="M20 8 l1 1" stroke="${C.fire}" stroke-width="1.2"/>`,
  RPG_TEAM: `<circle cx="10" cy="5" r="2" fill="${C.steel}"/><path d="M7 10 l3 -2 3 2 -1 7 h-4 Z" fill="${C.darkSteel}" stroke="${C.shadow}" stroke-width="0.8"/><path d="M14 9 l5 -2 -1 5 -3 1 Z" fill="${C.iron}" stroke="${C.darkSteel}" stroke-width="0.6"/><path d="M18 7 l2 0 0 3 -2 0 Z" fill="${C.fire}" opacity="0.7"/>`,
  // Mobilized / atomic era
  MOBILIZED_INFANTRY: `<path d="M9.5 3.5 Q12 2.5 14.5 3.5" fill="none" stroke="${C.darkSteel}" stroke-width="0.8"/><circle cx="12" cy="5" r="2.2" fill="${C.steel}"/><path d="M8 11 l4 -2 4 2 -1 7 h-6 Z" fill="${C.darkSteel}" stroke="${C.shadow}" stroke-width="0.8"/><path d="M14 8 l6 -1 -1 4 -2 0 Z" fill="${C.iron}" stroke="${C.darkSteel}" stroke-width="0.6"/><rect x="4" y="13" width="4" height="4" rx="0.5" fill="${C.iron}" stroke="${C.darkSteel}" stroke-width="0.5"/>`,
  MOBILIZED_ARTILLERY: `<path d="M5 14 h14 l-1 4 H6 Z" fill="${C.darkSteel}" stroke="${C.shadow}" stroke-width="0.8"/><rect x="7" y="10" width="10" height="5" rx="1" fill="${C.iron}" stroke="${C.darkSteel}" stroke-width="0.6"/><path d="M12 8 v2" stroke="${C.steel}" stroke-width="1.4"/><path d="M14 11 l6 -2 -1 3 -3 1 Z" fill="${C.darkSteel}"/><circle cx="8" cy="19" r="2" fill="${C.shadow}"/><circle cx="16" cy="19" r="2" fill="${C.shadow}"/>`,
  MOTOR_ARTILLERY: `<path d="M4 16 h10 l-2 -4 H6 Z" fill="${C.darkSteel}"/><rect x="3" y="14" width="8" height="4" fill="${C.iron}" stroke="${C.darkSteel}" stroke-width="0.6"/><path d="M13 12 l6 -3 -1 5 -2 1 Z" fill="${C.steel}" stroke="${C.darkSteel}" stroke-width="0.6"/><circle cx="6" cy="19" r="1.5" fill="${C.shadow}"/><circle cx="10" cy="19" r="1.5" fill="${C.shadow}"/>`,
  TANK: `<path d="M3 16 h18 l-2 3 H5 Z" fill="${C.darkSteel}" stroke="${C.shadow}" stroke-width="0.8"/><rect x="8" y="11" width="8" height="5" fill="${C.iron}" stroke="${C.darkSteel}" stroke-width="0.6"/><path d="M12 9 v2" stroke="${C.steel}" stroke-width="1.4"/><path d="M16 13 l5 -1 -1 3 -2 0 Z" fill="${C.darkSteel}"/><circle cx="7" cy="19" r="1.5" fill="${C.shadow}"/><circle cx="12" cy="19" r="1.5" fill="${C.shadow}"/><circle cx="17" cy="19" r="1.5" fill="${C.shadow}"/>`,
  HEAVY_TANK: `<path d="M2 15 h20 l-2 4 H4 Z" fill="${C.shadow}" stroke="${C.shadow}" stroke-width="0.8"/><rect x="7" y="10" width="10" height="5" fill="${C.iron}" stroke="${C.darkSteel}" stroke-width="0.8"/><path d="M12 8 v2" stroke="${C.steel}" stroke-width="1.6"/><path d="M16 12 l6 -2 -1 4 -2 0 Z" fill="${C.shadow}"/><circle cx="6" cy="19" r="1.8" fill="${C.shadow}"/><circle cx="12" cy="19" r="1.8" fill="${C.shadow}"/><circle cx="18" cy="19" r="1.8" fill="${C.shadow}"/>`,
  ARMORED_CAR: `<path d="M4 15 h16 l-2 3 H6 Z" fill="${C.iron}" stroke="${C.darkSteel}" stroke-width="0.8"/><rect x="8" y="10" width="8" height="5" fill="${C.darkSteel}"/><path d="M12 8 v2" stroke="${C.steel}" stroke-width="1.2"/><circle cx="8" cy="19" r="2" fill="${C.shadow}"/><circle cx="16" cy="19" r="2" fill="${C.shadow}"/>`,
  // Generic replacements
  MERCENARY_KNIGHT: `<path d="M4 16 q-1 -5 4 -6 q3 -4 7 -2 q1 4 -2 5 l3 1 -1 3 -3 -1 q-1 3 -4 2 q-3 0 -4 -2 Z" fill="${C.iron}" stroke="${C.darkSteel}" stroke-width="1"/><circle cx="9" cy="7" r="2" fill="${C.steel}"/><path d="M16 8 l4 -2 -1 4 -3 1 Z" fill="${C.steel}"/>`,
  HOUSEHOLD_GUARD: `<circle cx="12" cy="5" r="2.2" fill="${C.steel}"/><path d="M8 11 l4 -2 4 2 -1 7 h-6 Z" fill="${C.steel}" stroke="${C.darkSteel}" stroke-width="1"/><path d="M6 11 q-2 4 0 7 h-3 Z" fill="${C.gold}" stroke="${C.goldDeep}" stroke-width="0.6"/>`,
  FRONTIERSMAN: `<path d="M5 16 q-1 -5 4 -6 q3 -4 7 -2 q1 4 -2 5 l3 1 -1 3 -3 -1 q-1 3 -4 2 q-3 0 -4 -2 Z" fill="${C.leatherLt}" stroke="${C.darkSteel}" stroke-width="0.8"/><circle cx="9" cy="7" r="2" fill="${C.leather}"/><path d="M16 8 l4 -2 -1 4 -3 1 Z" fill="${C.iron}" stroke="${C.darkSteel}" stroke-width="0.6"/>`,
  RAIDER: `<circle cx="12" cy="5" r="2.2" fill="${C.leather}"/><path d="M8 11 l4 -2 4 2 -1 7 h-6 Z" fill="${C.leather}" stroke="${C.shadow}" stroke-width="0.8"/><path d="M14 8 l4 -1 -1 3 -2 0 Z" fill="${C.iron}" stroke="${C.darkSteel}" stroke-width="0.5"/>`,
  AIRCRAFT_CARRIER: `<path d="M2 13 h20 l-3 6 H5 Z" fill="${C.darkSteel}"/><rect x="6" y="10" width="14" height="3" fill="${C.iron}"/><path d="M10 10 V7 l4 3" fill="${C.steel}" stroke="${C.steel}" stroke-width="0.6"/><path d="M5 19 q7 3 14 0" fill="${C.water}"/>`,
  TRANSPORT_SHIP: `<path d="M3 13 h18 l-3 5 H6 Z" fill="${C.iron}"/><rect x="7" y="8" width="10" height="5" fill="${C.darkSteel}"/><path d="M9 8 V5 h6 v3" fill="none" stroke="${C.steel}" stroke-width="1.4"/><path d="M5 18 q7 3 14 0" fill="${C.water}"/>`,
  SUBMARINE_II: `<path d="M3 13 q9 -7 18 0 q-9 5 -18 0 Z" fill="${C.darkSteel}"/><circle cx="16" cy="13" r="2" fill="${C.shadow}"/><path d="M7 10 v-3 h2 v3" stroke="${C.steel}" stroke-width="1.4"/><path d="M14 10 l3 0" stroke="${C.gold}" stroke-width="1"/>`,
